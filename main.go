...
import (
	...
	bacalhauorgv1 "bacalhau/api/v1"
	"bacalhau/controllers"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "b8811432.bacalhau.org",
	})
	if err != nil {
	...
	if err != nil {
		setupLog.Error(err, "unable to init bacalhau system config")
		os.Exit(1)
	}
	...
	bclient := publicapi.NewRequesterAPIClient(apiHost, apiPort)
	if bclient == nil {
...
func getDefaultHostPort() (string, uint16) {
	...
	return defaultAPIHost, defaultAPIPort
}
